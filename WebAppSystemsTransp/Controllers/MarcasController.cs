...
namespace WebAppSystemsTransp.Controllers
{
    public class MarcasController : Controller
    {
        ...
        public MarcasController(WebAppSystemsContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            return _context.Marca != null ?
                        ...
                        Problem("Entity set 'WebAppSystemsContext.Marca'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'WebAppSystemsContext.Marca'  is null.");
            }
            var marca = await _context.Marca.FindAsync(id);
            if (marca != null)
            {
